...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_category_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_category_t qt_meta_stringdata_category = {
    {
        QT_MOC_LITERAL(0, 8),  // "category"
        QT_MOC_LITERAL(9, 18),  // "on_alg_btn_clicked"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 19)   // "on_back_btn_clicked"
    },
    "category",
    "on_alg_btn_clicked",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_category[] = {
...
Q_CONSTINIT const QMetaObject category::staticMetaObject = { {
    ...
    qt_meta_stringdata_category.offsetsAndSizes,
...
void category::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_alg_btn_clicked(); break;
